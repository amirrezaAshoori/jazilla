...
export default function ProductDetailsTab({ product }) {
  ...
  function onReviewPagination(current) {
          ...
          <Tab.Panel className="lg:flex">
            <div className="text-sm sm:text-15px text-brand-muted leading-[2em] space-y-4 lg:space-y-5 xl:space-y-7">
              ...
              <p>
                ...
                arranges words, letters, numbers, and symbols for publication,display, or distribution—from clerical workers and newsletter
                  ...
                  {[5, 4, 3, 2, 1].map((id) => (
                    <RatingProgressBar
                      ...
                      ratingProgressItem={product?.rating_count?.find(
                        (rating) => Number(rating?.rating) === id
                      )}
                      ratingId={id}
                      ...
                      {paginateInfo && (
                        <div className="flex items-center justify-between border-t border-border border-opacity-70 py-4">
                          ...
                          {!!paginateInfo?.totalDocs && (
                            <div className="mb-2 flex items-center">
                              <Pagination
                                total={paginateInfo?.totalDocs} current={paginateInfo?.pagingCounter}
